...
XBot::widgets::robot::robot(): QWidget(), xbot_communication_plugin(boost::shared_ptr<urdf::ModelInterface const>(),"XBotCommunicationPlugin",std::vector<std::vector<std::map<std::string,std::string>>>(),std::vector<std::vector<std::map<std::string,std::string>>>(),std::vector<std::string>())
{
