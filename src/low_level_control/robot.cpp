...
XBot::widgets::robot::robot(): QWidget(), xbot_communication_plugin("XBotCommunicationPlugin",std::vector<std::vector<std::map<std::string,std::string>>>(),std::vector<std::string>())
{
